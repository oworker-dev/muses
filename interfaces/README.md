...
Describe external APIs, contracts, service capability maps, and Agent-readable interfaces here.

Standard surfaces:

- `service-map/` for ANSS service capability mapping across human UI, Hono API, CLI, MCP, and Skills
- `openapi/` for HTTP and OpenAPI contracts
